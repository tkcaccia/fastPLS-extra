...
# PLS-SVD is evaluated at 100 components and SIMPLS at 50 components.
...
representative <- predictions[["SIMPLS\nCPU (50)"]]
...
panel_e <- spectrum_panel(
    c(12, 0), "E  Representative SIMPLS held-out spectrum"
)
...
figure <- ((panel_a | panel_b) / (panel_c | panel_d) / (panel_e | panel_f)) +
    plot_annotation(
        ...
        subtitle = paste0(
            "PLS-SVD: 100 components; SIMPLS: 50 components; ",
