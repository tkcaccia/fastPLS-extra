...
ALLOWED_TABLES = {
    "Phase1/MANIFEST.csv",
    "Phase1/benchmark/MANIFEST.csv",
    "Phase1/benchmark/current_release_evidence/figure1_component_contract.csv",
    "Phase1/benchmark/gpu_cross_validation/fixed_component_counts_wide.csv",
    "Phase1/benchmark/gpu_cross_validation/selected_component_contract.csv",
    "Phase2/MANIFEST.csv",
    "Phase2/benchmark/multicore_selected/figure2_component_contract.csv",
}
ALLOWED_PACKAGE_DATA = {
    "data/breast.rda",
    "data/colon.rda",
    "data/fastpls_example.rda",
}
